...
class CharitiesControllerTest < ActionController::TestCase
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post :create, charity: { duties: @charity.duties, organization: @charity.organization, year: @charity.year }
    end
  ...
  test "should update charity" do
    patch :update, id: @charity, charity: { duties: @charity.duties, organization: @charity.organization, year: @charity.year }
    assert_redirected_to charity_path(assigns(:charity))
  end
